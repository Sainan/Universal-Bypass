...
ensureDomLoaded(()=>{
	...
	ddomainBypass("oracle.com", () => {
		ensureDomLoaded(() => {
		    // get All Download Links
		    let jdk_links = document.querySelectorAll("[data-file]");
			jdk_links.forEach((element) => {
			    // https://gist.github.com/wavezhang/ba8425f24a968ec9b2a8619d7c2d86a6#gistcomment-3377085
			    var link = element.getAttribute("data-file");
			    console.log(link);
				...
				// assign DDL link
				element.href = "https://javadl.oracle.com/webapps/download/GetFile/1.8.0_"+jre8[1]+"-b"+jre8[2]+"/"+jre8[3]+"/"+os_type+"-i586/"+jre8[4];
			    }
