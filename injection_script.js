...
// zt-protect.com bypass
domainBypass("zt-protect.com", () => {
    safelyNavigate(window.location.href.replace("to", "link"));
    ensureDomLoaded(() => {
        safelyNavigate(	$(".showURL").text());
	})
})
...
ensureDomLoaded(()=>{
	...
	domainBypass(/tr\.link|movienear\.me|lewat\.club|droidtamvan\.me|(liveshootv|modebaca)\.com|shrink\.world|link\.mymastah\.xyz|sportif\.id/,()=>{
	...
	domainBypass("neonime.org",()=>document.querySelectorAll("a[href^='https://neonime.org?fc3c3da826=']").forEach(a=>{
